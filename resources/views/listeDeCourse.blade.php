    ...
    <section class="text-gray-600 body-font">
        ...
        <div class="container px-5 py-24 mx-auto flex flex-col">
            ...
            <div class="lg:w-3/4 mx-auto p-5 border-2 border-gray-200 rounded-lg">
                <h2 class="font-medium title-font mt-3 mb-3 text-gray-800 text-2xl"></h2>
                    ...
                    <div class="sm:w-1/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                        ...
                        <form action="{{ route('listeDeCourse', ['id' => $getIdRecipe->idRecette]) }}" method="POST">
                            ...
                            <ul class="text-s tracking-widest">
                                ...
                                <li>{{ $calculateQuantity->ingNom }} {{ $calculateQuantity->updatedQuantity }} {{ $calculateQuantity->utiUniteDeMesure }}</li>
                                @endif
                                @endforeach
                            </ul>
